...
describe("CreativeDetail", () => {
  it("should render  with creative", () => {
    ...
    expect(createdBy).toHaveTextContent(
      "Crée par Test-firstName-1 Test-lastName-1"
    );

    const lastModified = screen.getByTestId("creative-lastModified");
    expect(lastModified).toHaveTextContent(
      "Dernière modification le 1 janvier 2023"
    );
